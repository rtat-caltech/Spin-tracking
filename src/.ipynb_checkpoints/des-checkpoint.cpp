...
__PREPROC__ static void _usekey(desprng_individual_t *thread_data, unsigned long *from);
__PREPROC__ static void _cookey(desprng_individual_t *thread_data, unsigned long *raw1);
__PREPROC__ static void _scrunch(unsigned char *outof, unsigned long *into);
__PREPROC__ static void _unscrun(unsigned long *outof, unsigned char *into);
__PREPROC__ static void _desfunc(desprng_common_t *process_data, unsigned long *block, unsigned long *keys);

__PREPROC__ void _deskey(desprng_common_t *process_data, desprng_individual_t *thread_data, unsigned char *key) /* Thanks to James Gillogly & Phil Karn! */
{
    int i, j, l, m, n;
...
__PREPROC__ void _des(desprng_common_t *process_data, desprng_individual_t *thread_data, unsigned char *inblock, unsigned char *outblock)
{
